...
//  Project6b
//
//  Created by Eduard Tokarev on 01.01.2022.
//
...
//
//        view.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-(==30)-[label1(labelHeight@999)]-[label2(label1)]-[label3(label1)]-[label4(label1)]-[label5(label1)]-(>=10)-|", options: [], metrics: metrics, views: viewsDictionary))
